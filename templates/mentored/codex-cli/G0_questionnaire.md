...
> Loaded on demand by AGENTS.md when G0 is incomplete.
...
**Step 9 — Verify.** Read each generated file. Grep for every placeholder pattern listed in AGENTS.md G0 status check — none may remain. Confirm unused templates deleted. Confirm every BuildFlow phase has a real proof command. Keep `_fill_manifest.md` as reference.
