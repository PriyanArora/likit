...
Identify which of the 13 habits from guide.md are most directly tested by this step. For each relevant habit, state what it looks like in practice at this exact step — not the general definition, but the specific application here.
