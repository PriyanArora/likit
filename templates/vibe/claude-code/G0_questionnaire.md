...
AI proposes a complete architecture:
...
6. Generate project-specific `BuildFlow.md`. Each phase keeps its three gate proofs (implementation complete, tests passing, human review). Make the BuildFlow goal checkboxes granular: each is the single smallest verifiable action, depends on at most one prior unverified step, and keeps a Proof line.
