...
All phase progression is governed by `AGENTS.md` and the gate system in `Progress.md`.

## Prime Directive

Write clean, well-structured code that follows the architecture approved in G0. Implementation belongs to Codex. Architecture decisions, scope approval, and code review belong to the human.
